...
#define SR_RXNE       (1U<<5) // RXNE bit is set when the receive data register is not empty!
...
void usart2_TX_RX_init(void) {
    ...
    USART2->CR1 |= USART2_RE | USART2_TE;  // ORing the two bits together!
...
char usart2_read(void){ 
    ...
    return (char) (USART2->DR & 0xFF); // read the data!
